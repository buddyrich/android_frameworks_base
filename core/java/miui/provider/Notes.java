...
public class Notes
{
  ...
  static
  {
    CONTENT_DATA_URI = Uri.parse("content://notes/data");
  }

  public static final class CallNote
    implements Notes.DataColumns
  {
  ...
  public static abstract interface DataColumns
  {
  ...
  public static abstract interface NoteColumns
  {
 ...
 * Qualified Name:     miui.provider.Notes
